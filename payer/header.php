    ...
    <div class="header-navbar navbar-expand-sm navbar navbar-horizontal navbar-fixed navbar-dark navbar-without-dd-arrow navbar-shadow bg-success" role="navigation" data-menu="menu-wrapper">
        <div class="navbar-container main-menu-content" data-menu="menu-container">
            <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="nav-item"><a class="dropdown-toggle nav-link" href="bioData.php"><i class="la la-users"></i><span>Profile</span></a>
                </li>
                <li class="nav-item"><a class="dropdown-toggle nav-link" href="revenuePayment.php"><i class="la la-money"></i><span>Pay Revenue</span></a>
                </li>
                <li class="nav-item"><a class="dropdown-toggle nav-link" href="paymentHistory.php"><i class="la la-book"></i><span>Revenue History</span></a>
                </li>
